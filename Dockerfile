...
#EXPOSE 8080
#
#COPY --from=build /build/libs/ams-0.0.1-SNAPSHOT.jar ams-0.0.1-SNAPSHOT.jar
#
#ENTRYPOINT ["java", "-jar", "ams-0.0.1-SNAPSHOT.jar"]

FROM openjdk:17-jdk-slim
#VOLUME /tmp
COPY build/libs/ams-0.0.1-SNAPSHOT.jar ams.jar
